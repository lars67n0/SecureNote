  ...
  return (
    ...
    <Flex className="bg-zinc-100 dark:bg-zinc-900  flex-1 items-center flex-col justify-between mt-6 md:mt-10 p-4 min-h-[75vh] rounded-md shadow-md">
      <Flex className='flex-col items-center justify-center w-full h-full mx-auto mt-20'>
        <TbShieldLockFilled className="md:h-40 md:w-40 h-20 w-20 dark:text-indigo-300 hidden md:block"/>
        <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-zinc-200 mb-4">
        Secure Note
      </h1>
      <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-8">
        Your notes, secured and accessible anywhere.
      </p>
      <Button className="bg-gray-900 dark:bg-indigo-400 dark:hover:bg-indigo-200 text-zinc-100 dark:text-gray-900 
